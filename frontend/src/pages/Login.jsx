...
const Login = () => {
    ...
    const onSubmitHandler = async (e)=>{
        try {
            e.preventDefault();
            //This is code for passing cookie from frontend to backend
            ...
            <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        ...
                        <input onChange={e => setEmail(e.target.value)} value={email} type="text" className='bg-transparent outline-none' placeholder='Email' required />
                    </div>

                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        <img src={assets.lock_icon} alt="" />
                        <input onChange={e => setPassword(e.target.value)} value={password} type="text" className='bg-transparent outline-none' placeholder='Password' required />
                    </div>
